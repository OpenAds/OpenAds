...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advertisement.status'
        db.add_column(u'advertisements_advertisement', 'status',
                      self.gf('django.db.models.fields.CharField')(default='a', max_length=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advertisement.status'
        db.delete_column(u'advertisements_advertisement', 'status')
