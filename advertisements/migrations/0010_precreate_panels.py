...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        side_ad = orm['advertisements.AdvertisementPanel'](
            name='Side Ad',
            height=125,
            width=125,
        )
        ...
        top_ad = orm['advertisements.AdvertisementPanel'](
            name='Banner Ad',
            height=90,
            width=728,
        )
        ...
        for advert in orm['advertisements.Advertisement'].objects.all():
            if advert.ad_type == 't':
                advert.panel = top_ad
                advert.save()
            else:
                advert.panel = side_ad
                advert.save()
