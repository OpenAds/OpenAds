...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Advertisement.panel'
        db.add_column(u'advertisements_advertisement', 'panel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['advertisements.AdvertisementPanel'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Advertisement.panel'
        db.delete_column(u'advertisements_advertisement', 'panel_id')
