...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'advertisements_provider', 'user',
        ...
        db.add_column(u'advertisements_provider', 'created_at',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=timezone.now, blank=True),
                      keep_default=False)

        # Adding field 'Provider.updated_at'
        db.add_column(u'advertisements_provider', 'updated_at',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'advertisements_provider', 'user_id')

        # Deleting field 'Provider.created_at'
        db.delete_column(u'advertisements_provider', 'created_at')

        # Deleting field 'Provider.updated_at'
        db.delete_column(u'advertisements_provider', 'updated_at')
