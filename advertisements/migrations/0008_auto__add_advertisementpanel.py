...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'AdvertisementPanel'
        db.create_table(u'advertisements_advertisementpanel', (
        ...
        db.send_create_signal(u'advertisements', ['AdvertisementPanel'])


    def backwards(self, orm):
        # Deleting model 'AdvertisementPanel'
        db.delete_table(u'advertisements_advertisementpanel')
